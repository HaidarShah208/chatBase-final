  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={
            'fixed left-1/2 top-1/2 z-50 w-[95vw] max-w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-[14px] border border-(--border) bg-(--white) px-9 py-12 shadow-md focus:outline-none'
          }
        >
          ...
          <Dialog.Description className="pt-5 text-base leading-tight text-(--grayish) md:text-lg">
