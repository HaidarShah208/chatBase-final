import { ChevronDown, FileText, Globe, Save, Settings } from 'lucide-react'
...
export function AgentInstructionsPanel() {
  return (
    <div className="flex h-full px-4 flex-col overflow-hidden bg-(--white) pt-18">
      ...
      <div className="mx-4 mb-3 flex items-center justify-between gap-3  bg-(--white) px-3 py-2.5">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            type="button"
            className="inline-flex h-8 w-8 items-center justify-center rounded-lg text-(--grayish) transition hover:bg-(--background)"
            aria-label="Settings"
          >
      ...
      <div className="min-h-0 flex-1 overflow-auto px-4 pb-4">
        <div className="min-h-full rounded-xl border border-(--border) bg-(--white) px-4 py-4">
