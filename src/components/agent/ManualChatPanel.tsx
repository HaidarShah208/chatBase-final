...
export function ManualChatPanel() {
  return (
    <div className="flex h-full w-full items-center justify-center bg-(--white)">
      <div className="flex h-full py-8 px-4 w-full flex-col gap-4 lg:mx-0">

        <div className="flex flex-1 flex-col items-center rounded-2xl border border-(--border) bg-(--white) px-6 py-7 text-center ">
        ...
        <div className="flex flex-1 flex-col items-center rounded-2xl border border-(--border) bg-(--white) px-5 py-6">
